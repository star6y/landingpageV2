...
import sandbox from '../static/images/sandbox.png';
  ...
  return (
    <div className="block m-6 more-margin">
      ...
      <div className="container">
        ...
        <div className="box has-text-left is-size-5  mb-6 project">
          <div className="project-link">
            <a href="/sandbox" target="" rel="noopener noreferrer">
              <img src={sandbox} alt="" className="project-image " />
            </a>
          </div>
          ...
          <div className="project-info">
            <div className="title-date">
              ...
              <span className="project-date mb-5"> Jun 2024</span>
            </div>
            <p className="mb-5">
              I had so much fun while integrating, testing, and playing with the particle effect on the
              home page, that I decided I could make a mini-project out of it. In the sandbox, you can
              try out different effects, and change the size, color, text, and more.
            </p>
          </div>
        </div>
        ...
        <div className="box has-text-left is-size-5  mb-6 project">
          <div className="project-link">
            <a href="https://gray-forest-019e4ac0f.5.azurestaticapps.net/" target="_blank" rel="noopener noreferrer">
              <img src={momento} alt="" className="project-image " />
            </a>
          </div>
          ...
          <div className="project-info">
            <div className="title-date">
              <h2>Momento</h2>
              <span className="project-date mb-5"> May 2024</span>
            </div>
            <p className="mb-5">
        ...
        <div className="box has-text-left is-size-5  mb-6 project">
          <div className="project-link">
            <a href="https://github.com/star6y/VotingSystem/tree/main" target="_blank" rel="noopener noreferrer">
              <img src={votingSystem} alt="" className="project-image " />
            </a>
          </div>
          ...
          <div className="project-info">
            <div className="title-date">
              ...
              <span className="project-date mb-5"> Apr 2024</span>
            </div>
            <p className="mb-5">
        ...
        <div className="box has-text-left is-size-5  mb-6 project">
          ...
          <div className="project-info">
            <div className="title-date">
              <h2>To-Do app</h2>
              <span className="project-date mb-5"> Mar 2024</span>
            </div>
            <p className="mb-5">
        ...
        <div className="box has-text-left is-size-5  mb-6  project">
          <div className="project-link">
            <a href="https://project-1-ice-water.onrender.com/" target="_blank" rel="noopener noreferrer">
              <img src={novelNotes} alt="" className="project-image " />
            </a>
          </div>
          ...
          <div className="project-info">
            <div className="title-date">
              <h2>NovelNotes</h2>
              <span className="project-date mb-5"> Feb 2024</span>
            </div>
            <p className="mb-5">
        ...
        <div className="box has-text-left is-size-5  mb-6 mt-6 project">
          <a href="https://package-delivery-simulation.onrender.com" className="project-link" target="_blank" rel="noopener noreferrer">
            <img src={sim} alt="" className="project-image" />
          </a>
          <div className="project-info">
            <div className="title-date">
              <h2>Package Delivery Simulation</h2>
              <span className="project-date"> Dec 2023</span>
            </div>
            <p className="mb-5">
